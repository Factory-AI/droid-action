...
export const mockIssueAssignedContext: ParsedGitHubContext = {
  ...
  payload: {
    ...
    assignee: {
      ...
      html_url: "https://github.com/droid-bot",
    },
    issue: {
      number: 123,
  ...
  entityNumber: 123,
  isPR: false,
  inputs: { ...defaultInputs, assigneeTrigger: "@droid-bot" },
};
...
export const mockIssueLabeledContext: ParsedGitHubContext = {
  ...
  payload: {
    ...
    label: {
      ...
      name: "droid-task",
      color: "f29513",
      description: "Label for Droid interactions",
    },
    repository: {
      name: "test-repo",
      full_name: "test-owner/test-repo",
  ...
  entityNumber: 1234,
  isPR: false,
  inputs: { ...defaultInputs, labelTrigger: "droid-task" },
};
...
export const mockIssueCommentContext: ParsedGitHubContext = {
  ...
  payload: {
    ...
    comment: {
      id: 12345678,
      body: "@droid can you help explain how to configure the logging system?",
      user: {
  ...
  entityNumber: 55,
  isPR: false,
  inputs: { ...defaultInputs, triggerPhrase: "@droid" },
};
...
export const mockPullRequestCommentContext: ParsedGitHubContext = {
  ...
  payload: {
    ...
    comment: {
      id: 87654321,
      body: "/droid please review the changes and ensure we're not introducing any new memory issues",
      user: {
        login: "reviewer-user",
        id: 66666,
...
export const mockPullRequestReviewContext: ParsedGitHubContext = {
  ...
  payload: {
    ...
    review: {
      id: 11122233,
      body: "@droid can you check if the error handling is comprehensive enough in this PR?",
      user: {
...
export const mockPullRequestReviewCommentContext: ParsedGitHubContext = {
  ...
  payload: {
    ...
    comment: {
      id: 99988877,
      body: "/droid is this the most efficient way to implement this algorithm?",
      user: {
        login: "code-reviewer",
        id: 22222,
